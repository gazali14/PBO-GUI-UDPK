...
public class ViewPanel extends javax.swing.JPanel {
    ...
    private void loadData(Perusahaan perusahaan, QuestionaireData kuisioner){
        try {
                ...
                jmlPekerjaTotalSpinner.setValue(kuisioner.getBanyakPekerjaLaki()+kuisioner.getBanyakPekerjaPerempuan());
                ...
                namaContactPersonField.setText(kuisioner.getContactPerson());
                jabatanContactPersonField.setText(kuisioner.getJabatan_cp());
                ...
                tanggalPencacahanField1.setText(kuisioner.getTanggalPencacahan());
                ...
                System.out.println("Muat data berhasil!");
    ...
    private void initComponents() {
        ...
        jmlPekerjaLakiSpinner.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
            }
            public void inputMethodTextChanged(java.awt.event.InputMethodEvent evt) {
                jmlPekerjaLakiSpinnerInputMethodTextChanged(evt);
            }
        });
        jmlPekerjaLakiSpinner.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                jmlPekerjaLakiSpinnerPropertyChange(evt);
            }
        });
        ...
        jmlPekerjaTotalSpinner.setEnabled(false);
        ...
        tanggalPengawasanField.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        tanggalPengawasanField.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 153, 51)));
        tanggalPengawasanField.setSelectionColor(new java.awt.Color(255, 153, 51));
        tanggalPengawasanField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tanggalPengawasanFieldActionPerformed(evt);
            }
        });
        ...
        simpanButton.setBackground(new java.awt.Color(0, 255, 51));
        ...
        jLabel20.setFont(new java.awt.Font("Segoe UI", 2, 8)); // NOI18N
        jLabel20.setText("*akan berubah saat data disimpan");
                                                ...
                                                .addGroup(jPanel1Layout.createSequentialGroup()
                                                    ...
                                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                            ...
                                                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                            .addComponent(tanggalPengawasanField, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE))))
                                                .addGroup(jPanel1Layout.createSequentialGroup()
                                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void tanggalPengawasanFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tanggalPengawasanFieldActionPerformed
        // TODO add your handling code here:
    ...
    private void simpanButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanButtonActionPerformed
        ...
        // Set properties for Perusahaan from form fields
        perusahaan.setKIP(KIPTextField.getText());
        perusahaan.setNamaPerusahaan(NamaPerusahaanTextField.getText());
        ...
        // Set properties for QuestionaireData from form fields
        kuisioner.setKIP(KIPTextField.getText());
        kuisioner.setStatusUsaha(statusPerusahaanComboBox.getSelectedItem().toString());
        kuisioner.setGred(kualifikasiPerusahaanComboBox.getSelectedItem().toString());
        kuisioner.setBadanUsaha(badanHukumComboBox.getSelectedItem().toString());
        kuisioner.setPekerjaanUtama(jenisBoronganField.getText());
        kuisioner.setBidangPekerjaanUtama(bidangPekerjaanComboBox.getSelectedItem().toString());
    ...
    private void jmlPekerjaLakiSpinnerInputMethodTextChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_jmlPekerjaLakiSpinnerInputMethodTextChanged
        // TODO add your handling code here:
        jmlPekerjaTotalSpinner.setValue((int) jmlPekerjaLakiSpinner.getValue()+ (int) jmlPekerjaPerempuanSpinner.getValue());
    }//GEN-LAST:event_jmlPekerjaLakiSpinnerInputMethodTextChanged

    private void jmlPekerjaLakiSpinnerPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jmlPekerjaLakiSpinnerPropertyChange
        // TODO add your handling code here:
        jmlPekerjaTotalSpinner.setValue((int) jmlPekerjaLakiSpinner.getValue()+ (int) jmlPekerjaPerempuanSpinner.getValue());
    }//GEN-LAST:event_jmlPekerjaLakiSpinnerPropertyChange
    ...
    private javax.swing.JTextField tanggalPengawasanField;
