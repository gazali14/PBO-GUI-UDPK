 ...
 * @author U53R
 */
public class homePanelFrame extends javax.swing.JFrame {

    /**
     * Creates new form homePanel
     */
    public homePanelFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(homePanelFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new homePanelFrame().setVisible(true);
            }
        });
    }
