 ...
 * @author U53R
 */
public class kuisionerPanelFrame extends javax.swing.JFrame {

    /**
     * Creates new form kuisionerPanel
     */
    public kuisionerPanelFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(kuisionerPanelFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new kuisionerPanelFrame().setVisible(true);
            }
        });
    }
